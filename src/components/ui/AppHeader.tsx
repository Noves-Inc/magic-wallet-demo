    ...
    <div className="app-header-container">
      <div className="flex flex-col gap-2.5 items-center">
        <div className="flex gap-6 items-end">
          <Link href='https://noves.fi' target="_blank" className="flex flex-col gap-2.5 items-center cursor-pointer">
            <Image src={novesLogo} alt="noves" className='w-8' />
            <div className="text-center text-white text-xl font-extrabold leading-[30px] tracking-wider">Noves</div>
          </Link>
          <div className="flex flex-col gap-2.5 items-center">
